        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              { name: 'Arnavutköy', slug: 'arnavutkoy-atalay-servisi' },
              { name: 'Ataşehir', slug: 'atashehir-atalay-servisi' },
              { name: 'Avcılar', slug: 'avcilar-atalay-servisi' },
              { name: 'Bağcılar', slug: 'bagcilar-atalay-servisi' },
              ...
              { name: 'Beylikdüzü', slug: 'beylikduzu-atalay-servisi' },
              ...
              { name: 'Silivri', slug: 'silivri-atalay-servisi' },
              { name: 'Şişli', slug: 'sisli-atalay-servisi' },
              { name: 'Sultangazi', slug: 'sultangazi-atalay-servisi' },
      ...
      <section className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-6">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li><strong>Telefon:</strong> +90 536 931 96 67</li>
